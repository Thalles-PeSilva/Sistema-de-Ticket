...
CREATE TABLE usuarios_categoria (
  ...
  categoria_id_categoria INTEGER UNSIGNED NOT NULL,
  PRIMARY KEY(usuarios_id, categoria_id_categoria),
  INDEX usuarios_has_categoria_FKIndex1(usuarios_id),
  INDEX usuarios_has_categoria_FKIndex2(categoria_id_categoria)
);
